...
| `operator` | [ArithmeticOperator](#arithmeticoperator), [ComparisonOperator](#comparisonoperator) | Required | The comparison or arithmetic operator to use in the condition | Examples: eq |
