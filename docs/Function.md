...
| `params` | List[ForwardRef('Expression'), ForwardRef('FunctionCall'), [DBColumnReference](DBColumnReference.md), str, int, float, bool] | Optional | Optional parameters to pass to the function |  |
