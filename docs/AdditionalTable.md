...
| `relationKeys` | List[[RelationKey](RelationKey.md)] | Required | The names of the relation keys (columns) of the tables related |  |
| `conditions` | List[[Condition](Condition.md), [Regex](Regex.md)] | Required | A list of conditions to apply as filters |  |
